...
import cn.demomaster.quicktreeview.FileNode;
import cn.demomaster.quicktreeview.R;
import cn.demomaster.quicktreeview.adapter.SimpleTreeAdapter;
import cn.demomaster.quicktreeview.base.BaseActivity;
...
public class ListViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView mTree = findViewById(R.id.lv_tree);
        //第一个参数  ListView
        //第二个参数  上下文
        //第三个参数  数据集
        //第四个参数  默认展开层级数 0为不展开
